...
class StoreOrderRequest extends MobileFormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'delivery_date.required' => $this->msg('Delivery date is required.', 'تاريخ التوصيل مطلوب.'),
            'delivery_date.date' => $this->msg('Delivery date must be a valid date.', 'تاريخ التوصيل يجب أن يكون تاريخاً صالحاً.'),
            'delivery_time.required' => $this->msg('Delivery time is required.', 'وقت التوصيل مطلوب.'),
            'delivery_time.regex' => $this->msg(
                'Delivery time must be a valid time (e.g. 09:30 or 09:30:00).',
                'وقت التوصيل يجب أن يكون وقتاً صالحاً (مثل 09:30 أو 09:30:00).'
            ),
